# VR Lab – Aircraft Education in Virtual Reality

## Overview

**VR Lab** is an immersive, interactive educational platform developed with **Unity** and **C#** on the Meta XR Toolkit, tailored for teaching **aircraft engineering concepts** in a **virtual reality (VR)** environment. It simulates real-world aircraft systems and principles in an engaging 3D space optimized for hands-on learning.

Designed for both individual and local multiplayer experiences, VR Lab empowers students and trainees to explore complex aeronautical concepts in a scalable and modular virtual training lab.
...
- **Spatial Detection**: Accurate detection of user movement and orientation within the VR space.
- **Fluid Animations**: Smooth, real-time interactions designed for immersive training scenarios.
...
- Clear **user hierarchy** to manage different roles (e.g., instructor vs. student).
...
- **Language**: C#
- **Target Platform**: VR
- **Interaction System**: Meta XR Toolkit
- **Networking**: Local multiplayer framework (Photon)
